...
import './OakEditBlockTypeToolbar.scss';
...
const OakEditBlockTypeToolbar = (props: Props) => {
  const _handleChange = (action: OakEditBlockType) => {
    props.handleChange(action);
  };

  return (
    <div className="oak-edit-block-type-toolbar">
      <OakEditToolbarButton
        handleClick={() => _handleChange(OakEditBlockType.HEADING)}
      >
      ...
      <OakEditToolbarButton
        handleClick={() => _handleChange(OakEditBlockType.PARAGRAPH)}
      >
      ...
      <OakEditToolbarButton
        handleClick={() => _handleChange(OakEditBlockType.LIST)}
      >
      ...
      <OakEditToolbarButton
        handleClick={() => _handleChange(OakEditBlockType.PLAIN_TEXT)}
      >
      ...
      <OakEditToolbarButton
        handleClick={() => _handleChange(OakEditBlockType.IMAGE)}
      >
      ...
      <OakEditToolbarButton
        handleClick={() => _handleChange(OakEditBlockType.MARKDOWN)}
      >
...
export default OakEditBlockTypeToolbar;
