...
const OakEditList = (props: Props) => {
  ...
  return (
    <div className="oak-edit-list">
      ...
      />
      <div
        className={`oak-edit-list__input ${
          editing ? 'oak-edit-list__input--editing' : ''
        }`}
      >
        <OakEditRichText
          blockStyle
