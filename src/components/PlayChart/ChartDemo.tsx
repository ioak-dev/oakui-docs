  ...
  return (
    <div className="chart-demo">
      <div className="chart-demo-container" id="chart-demo-container">
        ...
        <div>
          {show && (
            <OakCard title="Bar chart, by category - stacked">
              <OakChartBar
                datasets={data}
                type="category"
                categoryLabels={['Jan', 'Feb', 'March', 'April']}
        ...
        <div>
          {show && (
            <OakCard title="Bar chart, by category">
              <OakChartBar
                datasets={data}
                type="category"
                categoryLabels={['Jan', 'Feb', 'March', 'April']}
        ...
        <div>
          {show && (
            <OakCard title="Line chart, by category - stacked">
              <OakChartLine
                datasets={data}
                type="category"
                categoryLabels={['Jan', 'Feb', 'March', 'April']}
        ...
        <div>
          {show && (
            <OakCard title="Line chart, by category">
              <OakChartLine
                datasets={data}
                type="category"
                categoryLabels={['Jan', 'Feb', 'March', 'April']}
        ...
        <div>
          {show && (
            <OakCard title="Linear line chart - stacked">
        ...
        <div>
          {show && (
            <OakCard title="Linear line chart">
