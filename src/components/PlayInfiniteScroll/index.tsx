...
import overviewContent from '../../assets/OakDividerOverview.json';
import overviewApi from '../../assets/OakDividerApi.json';
...
const PlayInfiniteScroll = (props: Props) => {
...
export default PlayInfiniteScroll;
