...
import overviewContent from '../../assets/OakClickAreaOverview.json';
import overviewApi from '../../assets/OakClickAreaApi.json';
...
const PlayClickArea = (props: Props) => {
